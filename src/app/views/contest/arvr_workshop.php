...
<article class="page full">
    <div class="container">
        <h1 class="text-center">
            <small><a class="underlined" href="<?= locale_base_url() ?>talks-and-workshops/arvr/"><?= __('AR-VR workshop') ?></a></small><br/>
            <br/><br/><?= __('Register') ?>
        </h1>
        <?php if (!$errors && $user_details): ?>
            <?php if ($user_details['payment_status'] != 'success'): ?>
                ...
                <p class="text-center">
                    But your payment is unsuccessful. If you think this is a mistake, please email us at <a href="mailto:contact@felicity.iiit.ac.in" class="underlined">contact@felicity.iiit.ac.in</a>
                </p>
